...
# Mapping языковых кодов проекта к кодам Google Translate
LANGUAGE_MAPPING = {
    'uk': 'uk',  # украинский
    'en': 'en',  # английский  
    'pl': 'pl',  # польский
...
def detect_primary_language(title_uk: str = None, title_en: str = None, title_pl: str = None, title_fr: str = None, title_de: str = None,
    ...
    """
    Определяет основной язык на основе заполненных полей.
    Возвращает код языка, который был заполнен пользователем.
    """
    ...
    # Если заголовок не заполнен, проверяем описание
...
async def auto_translate_bid_fields(title_uk: str = None, title_en: str = None, title_pl: str = None, title_fr: str = None, title_de: str = None,
    ...
    """
    Автоматически переводит поля заявки на недостающие языки.
    Возвращает словарь с переведенными полями.
    """
    print(f"DEBUG: auto_translate_bid_fields called with:")
    print(f"  title_uk={title_uk}, title_en={title_en}, title_pl={title_pl}")
    print(f"  description_uk={description_uk}, description_en={description_en}, description_pl={description_pl}")
    result = {
        'title_uk': title_uk,
        'title_en': title_en, 
        'title_pl': title_pl,
        ...
        'auto_translated_fields': []  # Список полей, которые были автоматически переведены
    }
    ...
    # Получаем основной заголовок и описание
...
async def auto_translate_company_fields(name_uk: str = None, name_en: str = None, name_pl: str = None, name_fr: str = None, name_de: str = None,
                                       description_uk: str = None, description_en: str = None, description_pl: str = None, description_fr: str = None, description_de: str = None) -> Dict[str, str]:
    """
    Автоматически переводит поля профиля компании на недостающие языки.
    Возвращает словарь с переведенными полями.
    """
    result = {
    ...
    # Определяем основной язык для названия компании
...
def is_field_auto_translated(field_name: str, auto_translated_fields: list) -> bool:
    """
    Проверяет, было ли поле автоматически переведено.
    """
    return field_name in auto_translated_fields

def get_translation_marker(lang: str) -> str:
    """
    Возвращает маркер перевода для указанного языка.
    """
    markers = {
        'uk': '(перекладено)',
        'en': '(translated)', 
